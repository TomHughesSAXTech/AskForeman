// Fixed n8n Google Search Node Code
// This code properly calls the Azure Function with query parameters
...
try {
  ...
  // IMPORTANT: Use GET request with query parameters instead of POST with body
